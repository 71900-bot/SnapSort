...
document.querySelector<HTMLDivElement>('#app')!.innerHTML = `
  <main class="app-shell">
    ...
    <section class="quick-guide" aria-label="How SnapSort works"><div class="guide-heading"><span class="guide-spark">✦</span><div><strong>How it works</strong><small>Three little steps, one much tidier folder.</small></div></div><div class="guide-steps"><div class="guide-step"><span>1</span><strong>Choose pictures</strong><small>Select a folder in the desktop app, or add files for a browser preview.</small></div><div class="guide-step"><span>2</span><strong>Make a rule</strong><small>Pick a prefix, starting number, and number width.</small></div><div class="guide-step"><span>3</span><strong>Check and go</strong><small>Review the new names, then rename or download your batch.</small></div></div><div class="platform-note"><span>▣</span><strong>Use it your way:</strong> Browser version downloads a renamed ZIP. Windows desktop version renames files directly in their folder.</div></section>
